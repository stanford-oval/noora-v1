    ...
    <div className="bg-gray-200">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
        <h2 className="text-2xl font-bold tracking-tight leading-tight text-gray-900 sm:text-3xl">
          ...
          <span className="block text-noora-primary">
        ...
        <div className="mt-7 flex lg:mt-0 lg:flex-shrink-0">
          <div className="inline-flex">
            <Link href="/modules">
              <button className="inline-flex items-center justify-center px-5 py-3 text-base font-medium rounded-full text-white bg-noora-primary hover:bg-noora-primary-dark">
                Get Started
