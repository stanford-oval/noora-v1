...
export default function Hero() {
  return (
    <div
      className="bg-gray-100 bg-cover bg-no-repeat bg-center overflow-hidden min-h-screen flex flex-col justify-center align-center"
      id="homeHero"
    >
      <div className="container pb-14 md:py-18 pt-28 lg:pt-14">
